...
module PgHero
  ...
  class << self
    ...
    def_delegators :current_database, :access_key_id, :autoindex, :autoindex_all, :autovacuum_danger,
      ...
      :cpu_usage, :create_user, :database_size, :db_instance_identifier, :drop_user,
      :duplicate_indexes, :explain, :historical_query_stats_enabled?, :index_caching,
      ...
      :query_stats_enabled?, :query_stats_extension_enabled?, :query_stats_readable?,
